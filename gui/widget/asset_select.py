# Vendored fork of pysepal 3.6.1 pysepal/solara/components/inputs/asset_select.py.
# Adds `initial`-driven seeding of the asset selection. Re-diff on any pysepal bump.
