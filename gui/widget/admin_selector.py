# Vendored fork of pysepal 3.6.1 pysepal/solara/components/inputs/admin_selector.py.
# Adds `initial`-driven cascade restore. Re-diff against upstream on any pysepal bump.
