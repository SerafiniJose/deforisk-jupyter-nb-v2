...
imports that must follow it. Six render modules do not
(test_evaluation, test_echarts_adapter, test_pipeline_header,
test_summary_tile_reactivity, test_notification_area_reactivity,
test_postprocess_tile_threading). None of them trips the bug today; doing the
warm-up once here makes that a property of the suite rather than a coincidence
of which components each module happens to mount.
